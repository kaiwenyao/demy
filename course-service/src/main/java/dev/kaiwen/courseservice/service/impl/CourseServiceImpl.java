...
import dev.kaiwen.courseservice.dto.CourseRequest;
import dev.kaiwen.courseservice.dto.CourseResponse;
import dev.kaiwen.courseservice.dto.SectionRequest;
import dev.kaiwen.courseservice.dto.SectionResponse;
...
public class CourseServiceImpl implements CourseService {
  ...
  @Cacheable(value = "courses", key = "(#category ?: 'all') + ':' + #pageable.pageNumber + ':' + "
      + "#pageable.pageSize")
  @Override
  ...
  @Cacheable(value = "course:internal", key = "#id")
  @Override
  ...
  @Caching(evict = {
      ...
      @CacheEvict(value = "courses", allEntries = true),
      @CacheEvict(value = "course:internal", key = "#courseId")
  })
  @Override
